...
def createScene(root):
    ...
    root.addObject('RequiredPlugin', name="mecha", pluginName="SofaBoundaryCondition SofaConstraint SofaDeformable SofaImplicitOdeSolver SofaMeshCollision SofaMiscFem SofaSparseSolver SofaSimpleFem") 
    ...
    size3d = [1, 1, 1]
    grid = [10, 10, 10]
    Obstacles.createDeformableCactus(root, "Cactus", translation3d, size3d, grid, [-1, -1, -101, 201, 50, 101])
